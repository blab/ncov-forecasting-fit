...
error_dataset_fullrank = read.csv('../estimates_fullrank/model_scores_output.csv') %>%
  mutate(model = recode(model, dummy = "Naïve")) 

range(error_dataset$MAE)
...
med_log_error_30 = error_dataset %>%
  ...
  #ylim(-0.05,0.05)+
  scale_y_continuous(
    limits = c(-0.05, 0.05), # This sets the limits from 0% to 5%
    breaks = seq(-0.05, 0.05, by = 0.025), # This sets the breaks at every 1% increment
    labels = scales::percent(seq(-0.05, 0.05, by = 0.025)) # This sets the labels to show the percentages
  ) +
  #scale_y_continuous(trans = log_trans(),
...
mae_nat_error_30 =error_dataset %>%
  ...
  scale_color_manual(values = model_colors,
                     breaks = c("Naïve", "Piantham", "MLR", "FGA", "GARW")) +
  labs(x = "Days from date of estimation", y = "Mean Bias Error") +
  scale_x_continuous(breaks = c(-30, -14, 0, 14, 30)) +
    scale_y_continuous(
    limits = c(-0.1, 0.1), # This sets the limits from 0% to 5%
    breaks = seq(-0.1, 0.1, by = 0.025), # This sets the breaks at every 1% increment
    labels = scales::percent(seq(-0.1, 0.1, by = 0.025))# This sets the labels to show the percentages
  ) +
    scale_y_continuous(
    limits = c(0, 0.2), # This sets the limits from 0% to 5%
    breaks = seq(0, 0.1, by = 0.025), # This sets the breaks at every 1% increment
    labels = scales::percent(seq(0, 0.1, by = 0.025)) # This sets the labels to show the percentages
...
#-30 LEAD
    tab_style(style = list(
            ...
            locations = cells_body(columns= c(Median_Piantham,Median_FGA, Median_GARW,Median_MLR , Mean_FGA, Mean_GARW, Mean_MLR, Mean_Piantham), 
                                   rows = 1)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_Piantham, Median_MLR, Mean_FGA), 
                                   rows = 2)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_Piantham,Median_FGA, Median_GARW,Median_MLR, Mean_Piantham), 
                                   rows = 3)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_FGA, Median_GARW, Mean_FGA, Mean_GARW), 
                                   rows = 4)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
      ...
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_Piantham,Median_FGA, Median_GARW,Median_MLR,  Mean_FGA, Mean_GARW, Mean_MLR), 
                                   rows = 6)) %>%
...
#0 LEAD
      ...
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_MLR, Median_FGA, Median_GARW,Mean_GARW  ), 
                                   rows = 8)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
      ...
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW, Mean_FGA, Mean_GARW), 
                                   rows = 11)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
...
#30 LEAD
      ...
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_FGA, Median_GARW, Mean_FGA), 
                                   rows = 14)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_FGA, Median_GARW, Median_MLR, Mean_MLR), 
                                   rows = 15)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_FGA, Median_GARW, Median_MLR, Median_Piantham, Mean_MLR), 
                                   rows = 16)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_FGA, Median_GARW, Median_MLR, Mean_MLR), 
...
countries <- unique(error_dataset$location)
models <- c("MLR", "GARW", "Piantham", "FGA")
...
```{R}
Supp_1_countries = c("USA", "United Kingdom", "Brazil","Australia","South Africa", "Japan", "Malaysia", "Egypt")
ylim_values <- c(10000, 10000, 1000, 1000, 1000, 2000, 1000, 100)
...
supp1_Test = plot_all_countries_sequences(Supp_1_countries, seqs_first, seq_mid, seq_mid2, seq_last, ylim_values)

ggsave("supp1_Test.png", plot = supp1_Test, width = 30, height = 40, units = "cm" )
