...
seq_qc <- read.csv("../data/seq_counts_qc.tsv", sep =  "\t")
...
#-30 LEAD
    tab_style(style = list(
            ...
            locations = cells_body(columns= c( Median_Piantham, Mean_FGA, Mean_MLR, Mean_Piantham), 
                                   rows = 1)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_Piantham, Median_GARW, Mean_MLR), 
                                   rows = 2)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW, Median_FGA, Median_MLR, Median_GARW, Median_Piantham, Mean_GARW, Mean_Piantham, Mean_MLR), 
                                   rows = 3)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW,Median_FGA, Mean_GARW, Mean_FGA), 
                                   rows = 4)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_MLR,Median_GARW, Median_FGA, Mean_MLR, Mean_FGA, Mean_GARW), 
                                   rows = 5)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
  ...
  tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_Piantham,Median_FGA, Median_GARW,Median_MLR, Mean_MLR, Mean_Piantham), 
                                   rows = 7)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
...
#0 LEAD
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_FGA, Median_MLR, Median_Piantham,Mean_FGA), 
                                   rows = 9)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c( Median_FGA,Mean_MLR), 
                                   rows = 10)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_MLR, Mean_MLR ), 
      ...
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW,Median_FGA,Median_MLR, Mean_GARW), 
                                   rows = 14)) %>%
    tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW, Mean_MLR), 
...
#30 LEAD
      ...
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_Piantham, Mean_Piantham), 
                                   rows = 18)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_FGA,Median_MLR,Median_GARW, Mean_GARW), 
                                   rows = 19)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW, Mean_FGA), 
      ...
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW, Mean_Piantham), 
                                   rows = 21)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c(Median_GARW,Median_FGA, Mean_FGA), 
                                   rows = 22)) %>%
  tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c( Median_GARW,Median_FGA, Mean_GARW, Mean_MLR), 
                                   rows = 23)) %>%
      tab_style(style = list(
                         cell_text(weight = 'bold')), 
            locations = cells_body(columns= c( Median_FGA, Mean_Piantham), 
                                   rows = 24)) %>%
 gt_theme_guardian()%>%
  tab_options(
...
models <- c("FGA",'GARW', 'Piantham', 'MLR')
countries = c('USA',
 'United Kingdom',
 'Brazil',
 'Australia',
