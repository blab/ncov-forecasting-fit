...
error_quant_30 = error_dataset %>%
  ...
  geom_line(aes(y =meanMAE ), alpha = 0.5)+
...
Figure_2 = ggpubr::ggarrange(error_quant_30, mae_dist, ncol = 1,
 ...
 # "Omicron 21A" ="#4272CE", "Omicron 21B" = "#006494", "Omicron 21C" ="#D95D39"
  scale_color_manual(values = variant_colorsga,
                     labels = c("Clade 22A | BA.4","Clade 22B | BA.5", "Clade 22C | BA.2.12.1",
                                "Clade 22D | BA.2.75", "Clade 22E | BQ.1", "Clade 23A | XBB.1.5"))+
...
seq_avail_corr = full_model_data %>%
  ...
  geom_point(size = 2)+
  stat_cor(method = "pearson", aes(x = seq_available+1, y = MAE), label.x = 3.5, inherit.aes = F)+
  theme_minimal()+
...
Figure_4 = ggarrange(qc_mae + rremove("ylab"), med_del_corr + rremove("ylab"), frac_seq_corr + rremove("ylab"),seq_avail_corr + rremove("ylab"),
                     ncol = 2, nrow = 2,
