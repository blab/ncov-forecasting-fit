...
Using sequences from the United Kingdom, we subsample existing sequences at a rate of ..., ..., ..., ... per week at various observation dates throughout the pandemic.
We then fit the MLR forecast model to each resulting data set and forecast for 30 days after observation date.
