...
\begin{figure}[H]
	\centering
    \includegraphics[width=1.1\textwidth]{figures/Figure3GA&Freq.png}
...
These variables are defined as fraction of sequences available within 14 days of the prediction time, total sequences availability within 14 days of the prediction time, median delay of sequence submission, and lead time from prediction day subsequently for each location.
...
All variables were calculated using Rstudio statistical software. (Figure 4)
