...
\tbc{Sentence introducing SARS-CoV-2 and the impact of the pandemic}
\tbc{Sentence describing the initial emergence of variant viruses and the impact of Omicron}
...
\tbc{Sentence describing continuing evolution post Omicron}
\tbc{Final sentence stating importance of understanding and forecasting variant dynamics (for vaccine strain selection, for projecting variant-driven epidemics).}
...
Additionally, models introduced by Figgins and Bedford \cite{figgins_bedford_freq_dyn} and by Piantham et al \cite{piantham2021estimating} incorporate case counts and variant-specific Rt, but still can be used to project variant frequencies.
