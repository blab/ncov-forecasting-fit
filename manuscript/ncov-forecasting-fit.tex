...
Throughout the following discussion, we refer to `absolute error (AE)' for a specific model $m$, a specific dataset $d$ and a specific forecasting lag $l$ as the mean absolute difference between predicted frequency and retrospective frequency across timepoints $t$, ie
\begin{equation}
\mathrm{AE}_{m, d, l, t} = \frac{1}{n} \sum_{t \in T} |f_{m, d, l, t} - \hat{f}_{m, d, l, t}|,
\end{equation}
