...
For a given observation date, we filter to all sequences which were collected 90 days before the observation date.
...
We explore four key variables to describe the effect of sequencing efforts on nowcast errors and found their Spearman correlations with the nowcast errors.
