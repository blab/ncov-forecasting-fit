...
\begin{figure}[H]
	...
	Truth smoothed frequency is represented in black, nowcasts are estimated for each clade with the data available at different observation dates. }
...
\paragraph{Comparison of Growth Advantages}\ We investigated the behavior of the growth advantage of different variants in different countries including Australia, Brazil, Japan, South Africa, United Kingdom, United States.
Using GARW, MLR, and Piantham models \jhc{Why these?}, we standardized the varying growth advantage by estimating the median growth advantage values as of that date.
...
We explore four key variables to better encompass \jhc{?} the effect of sequencing efforts which are fraction of sequences available, sequences available, median delay and lag time.
