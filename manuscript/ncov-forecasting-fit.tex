...
However, we also observe improvements in accuracy for the $-30$ day hindcast of modeled frequency relative to naive frequency with the MLR model showing improvement in median absolute error of 0.1--2.9\% and improvement in mean absolute eror of 0.9--5.2\%.
...
However, these models do not account for future mutations and can only project forwards from circulating viral diversity.
