...
In particular, we estimate the coverage of 95\% posterior latent frequencies (Supp.\ Fig.\ \ref{fig:frequency_coverage}A) and posterior predictive sample frequencies (Supp.\ Fig.\ \ref{fig:frequency_coverage}B) for the model explored in this paper.
